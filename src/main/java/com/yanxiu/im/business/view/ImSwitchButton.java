...
/**
 * Created by 朱晓龙 on 2018/6/5 11:16.
 *
 * from  :https://github.com/zcweng/SwitchButton
 */

public class ImSwitchButton extends View implements Checkable {
    ...
    public ImSwitchButton(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ImSwitchButton(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public ImSwitchButton(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
            typedArray = context.obtainStyledAttributes(attrs, R.styleable.ImSwitchButton);
        }

        shadowEffect = optBoolean(typedArray,
                R.styleable.ImSwitchButton_sb_shadow_effect,
                true);

        uncheckCircleColor = optColor(typedArray,
                R.styleable.ImSwitchButton_sb_uncheckcircle_color,
                0XffAAAAAA);//0XffAAAAAA;

        uncheckCircleWidth = optPixelSize(typedArray,
                R.styleable.ImSwitchButton_sb_uncheckcircle_width,
                dp2pxInt(1.5f));//dp2pxInt(1.5f);

        uncheckCircleOffsetX = dp2px(10);

        uncheckCircleRadius = optPixelSize(typedArray,
                R.styleable.ImSwitchButton_sb_uncheckcircle_radius,
                dp2px(4));//dp2px(4);
    ...
    public interface OnCheckedChangeListener {
        void onCheckedChanged(ImSwitchButton view, boolean isChecked);
    }
