...
/**
 * create by 朱晓龙 2018/8/16 下午4:52
 */
public class TopicDataListAdapter<E extends TopicItemBean> extends RecyclerView.Adapter<ImTopicBaseViewHolder> {
    /**
     * 数据集合
     */
    ...
    public TopicDataListAdapter(Context mContext) {
