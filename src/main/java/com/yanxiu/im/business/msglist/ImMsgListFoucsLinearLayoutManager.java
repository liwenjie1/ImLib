 ...
 */
public class ImMsgListFoucsLinearLayoutManager extends LinearLayoutManager {
    ...
    public ImMsgListFoucsLinearLayoutManager(Context context) {
        super(context);
    }

    public ImMsgListFoucsLinearLayoutManager(Context context, int orientation, boolean reverseLayout) {
        super(context, orientation, reverseLayout);
    }

    public ImMsgListFoucsLinearLayoutManager(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
